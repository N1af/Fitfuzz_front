...
const Men = () => {
  ...
  useEffect(() => {
    const fetchPosters = async () => {
      try {
        const res = await api.get("/api/men/posters");
        setPosters(res.data);
      } catch (err) {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const res = await api.get("/api/men/products", { params });
          ...
          <div className="flex-1">
            ...
            <div className="mb-8 md:mb-12">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Men's Collection</h2>
                ...
                return (
                  ...
                  >
                    ...
                    <CardContent className="p-5">
                      ...
                      {/* Product name */}
                      <h3 className="text-sm font-semibold mb-3 text-gray-900 line-clamp-2 hover:text-blue-600 transition-colors">
                        {p.name}
                      </h3>
